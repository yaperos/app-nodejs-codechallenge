...
import { TransactionVerifyRequest, TransactionVerifyUpdateRequest } from '../entities/transaction-verify-request';
...
export interface TransactionVerifyRepository {
    ...
    updateTransactionVerify(transactionVerifyRequestDto: TransactionVerifyUpdateRequest): Promise<void>;
