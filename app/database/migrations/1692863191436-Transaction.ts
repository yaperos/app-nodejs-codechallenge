...
export class Transaction1692863191436 implements MigrationInterface {
    name = 'Transaction1692863191436'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Transactions" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "version" integer NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "accountExternalIdDebit" character varying(36) NOT NULL, "accountExternalIdCredit" character varying(36) NOT NULL, "tranferTypeId" smallint NOT NULL, "value" numeric(10,2) NOT NULL, CONSTRAINT "PK_7761bf9766670b894ff2fdb3700" PRIMARY KEY ("id"))`);
