...
const MessagePattern = (metadata, transportOrExtras, maybeExtras) => {
    ...
    return (target, key, descriptor) => {
        ...
        Reflect.defineMetadata(constants_1.PATTERN_EXTRAS_METADATA, Object.assign(Object.assign({}, Reflect.getMetadata(constants_1.PATTERN_EXTRAS_METADATA, descriptor.value)), extras), descriptor.value);
        return descriptor;
    };
};
